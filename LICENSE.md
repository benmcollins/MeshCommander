...
- `app/qml/fonts/IBMPlexSans-*.ttf` — IBM Plex Sans, © IBM Corp., licensed
  under SIL OFL 1.1. See `app/qml/fonts/IBMPlex-OFL.txt`.
- `app/qml/fonts/JetBrainsMono-Regular.ttf` — JetBrains Mono, © JetBrains
  s.r.o., licensed under SIL OFL 1.1. See `app/qml/fonts/JetBrainsMono-OFL.txt`.
